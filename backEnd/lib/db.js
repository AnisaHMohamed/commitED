...
const createPost = (
  ...
  return db.query(
    `INSERT INTO opportunities(type, description, title, date_posted, user_id, address,longitude, latitude) VALUES($1,$2,$3,to_timestamp($4),$5,$6,$7,$8) RETURNING *;`,
    [
      type,
      description,
      title,
...
const createUser = (
  ...
  return db.query(
    `INSERT INTO users(name, address, phone_number, email, password, type,latitude, longitude) VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *;`,
...
const getEmailOfOpportunityOwner = (user_id) => {
  ...
  JOIN users ON users.id = opportunities.user_id WHERE opportunities.user_id = $1`,
    [user_id]
  );
};
...
module.exports = {
  ...
  createUser,
  getUserLatAndLng,
  getOpportunityLatAndLng,
  updateOpportunity,
  deleteOpportunities,
  getEmailOfOpportunityOwner,
  getUserInfoFromId,
};
